...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-xl">
            <a class="navbar-brand" href="#">
                <h3>Mendiagnosa Tipe kulit Wajah</h3>
            </a>
        ...
        <div class="container-xl">
            <div class="row position-relative">
                <div class="col align-self-center">
                    ...
                    <h6 class="font-weight-normal">Mendiagnosa dan Mengidentifikasi Tipe Kulit Wajah Menggunakan Metode Forward
                        Chaining</h6>
                    </p>
    ...
    <section id="alur" class="py-5 ">
        <!--Content2-->
        <div class="container-xl">
            <h1 style=" text-align: center;" class="font-weight-normal sub-heading ">Cari Tahu Tipe Kulit Wajah dan Saran Merawatnya</h1>
            <p class="pb-5 text-center font-weight-light">Ikuti petunjuk di bawah ini, agar anda tidak kesulitan dalam
                mendiagnosa tipe kulit wajah</p>
            <p></p>
            <div class="card-deck text-center ">
                <div class="card border">
                    <img src="gambar/biodata.jpeg" class="card-img-top  mx-auto mt-5" style="width: 300px; height:250px">
                ...
                <div class="card border">
                    <img src="gambar/ciri.jpeg" class="card-img-top mx-auto mt-5" style="width: 300px; height:250px">
                    <div class="card-body pt-5">
                        <h5 class="card-title">Pilih Ciri-Ciri</h5>
                        <p class="card-text font-weight-light">Dalam tahap ini pengguna akan diberikan beberapa
                            pertanyaan terkait dengan ciri-ciri yang dialami</p>
                    </div>
                </div>
                <div class="card border">
                    <img src="gambar/hasil.jpeg" class="card-img-top mx-auto mt-5" style="width: 300px; height:250px">
                    <div class="card-body pt-5">
                        <h5 class="card-title ">Hasil Tipe Kulit Dan Saran Perawatan</h5>
                        <p class="card-text font-weight-light">Hasil dari diagnosa akan muncul dan akan diberikan
                            saran terbaik</p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-30 mb-5 container-xl">
        ...
        <div class="row mb-5">
            <div class="col-5">
                <img src="gambar/image.jpeg" style="width: 400px; height:400px">
            </div>
            <div class="col-7 d-flex justify-content-center flex-column">
                <h2 class="mt-4 ">Metode Foward Chaining pada Sistem Pakar Mendiagnosa Tipe Kulit Wajah</h2>
                ...
                <div class="accordion mb-5" id="accordionExample">
                    ...
                    <div class="card mb-3">
                        <div class="card-header" id="headingTwo">
                            <h2 class="mb-0">
                                <button class="btn font-weight-bold btn-block text-left collapsed" type="button"
                                    ...
                                    Bagaimana Metode Forward Chaining Bekerja dalam Sistem Pakar Mendiagnosa Tipe Kulit Wajah?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#accordionExample">
                            <div class="card-body">
                                Dalam sistem pakar ini, metode Forward Chaining memulai dengan ciri-ciri yang
                                dialami pada kulit wajah, kemudian menerapkan aturan-aturan yang telah ditetapkan untuk
                                mencapai pendiagnosaan tipe kulitnya.
                            </div>
                        </div>
                    </div>
                    <div class="card mb-3">
                        <div class="card-header" id="headingThree">
                            <h2 class="mb-0">
                                <button class="btn font-weight-bold btn-block text-left collapsed" type="button"
                                    ...
                                    Mengapa Metode Forward Chaining dipilih untuk Sistem Pakar Mendiagnosa Tipe Kulit Wajah?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                            ...
                            <div class="card-body">
                                ...
                                yang tersedia adalah ciri-ciri yang mudah diamati, dan proses inferensi dapat
